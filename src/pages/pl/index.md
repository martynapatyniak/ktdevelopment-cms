...
<!-- CSS tylko dla tej strony: hamburger tylko na mobile (≤768px) -->
<style>
  /* Desktop: wyłącz własny hamburger/drawer z tej strony */
  ...
  /* Mobile: pokaż hamburger + drawer i ukryj poziome .nav z layoutu */
  @media (max-width: 768px){
    ...
    /* Animacja hamburger → X oraz otwieranie panelu */
...
<!-- === HAMBURGER (MOBILE-ONLY) — działa bez JS, ważna kolejność! === -->
